...
enum td_keycodes { //keycaps con doble funcionalidad
    ESCAPE,
//    COMMAND,
//    ALT
};
...
//  |--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
LCTL_T(KC_LABK), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                        MAC_N,   KC_M, KC_COMM,  KC_DOT, KC_MINUS,  LALT_T(KC_QUOTE),
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
...
/*
      ...
      |        |   !   |   �   |   #   |   $   |  %    |                         |   &   | HOME  |   UP   | END  |       | BACKSPC |
      |--------+-------+-------+-------+-------+-------|          _SYMB          |-------+-------+-------+-------+-------+---------|
      |    |   |   {   |   }   |   [   |   ]   |   \   |                         |    KC_QUOT   |  LEFT |  DOWN | RIGHT |       |  SFT     |
      |--------+-------+-------+-------+-------+-------|                         |-------+-------+-------+-------+-------+---------|
      |        |      |KC_TILD | <> |   KC_NUBS    |PSCREEN|                         |       |    �  |   ` |   �   |   ~   |         |
      '---------------------------------------------------------|       |----------------------------------------------------------'
...
//  |--------+--------+--------+--------+--------+--------|     /* _SYMB */    |--------+--------+--------+--------+--------+--------|
LSFT(KC_BSLS), KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_BSLS,                     KC_QUOT, KC_LEFT,  KC_DOWN, KC_RIGHT, XXXXXXX,KC_RSFT,
//  |--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, XXXXXXX, KC_PSCREEN,                   XXXXXXX, ALGR(KC_QUOTE), KC_GRV, ALGR(KC_BSLS), KC_TILDE, XXXXXXX,
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
                             MT(KC_LCMD,KC_TAB), _______, KC_SPC,      KC_SPC, MT(NUMP,KC_ENT), KC_ALGR
                                    //'----------------------------'  '---------------------------------'
  ),
...
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
                        MT(KC_LCMD,KC_TAB), MT(SYMB,KC_ENT), KC_SPC,    KC_SPC, _______, KC_ALGR
                               //'---------------------------------'  '--------------------------'
  ),
...
//  |--------+--------+--------+--------+--------+--------|     /* _TUNE */    |--------+--------+--------+--------+--------+--------|
       RGB_TOG, HUI,    RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,                     XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX,
//  |--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX,  HUD,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
//  '--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------'
                                MT(KC_LCMD,KC_TAB), _______, KC_SPC,     KC_SPC, _______, KC_ALGR
                                      //'--------------------------'  '--------------------------'
  )
};
